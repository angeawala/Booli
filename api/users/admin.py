...
class CustomUserAdmin(BaseUserAdmin):
    ...
    list_filter = (
        'is_active', 'is_staff', 'is_2fa_enabled', 'gender', 'country', 'roles'
    )
    search_fields = (
        'email', 'first_name', 'last_name', 'contact', 'country', 'city', 'roles'
    )
    ...
    fieldsets = (
        ...
        ('Informations personnelles', {
            'fields': (
                'first_name', 'last_name', 'contact', 'country', 'city',
                'birth_date', 'profession', 'gender', 'avatar',
                'address_line', 'postal_code', 'roles'
            )
        }),
        ('Permissions', {
            'fields': (
