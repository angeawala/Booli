      ...
      <section className="fond">
        <nav id="side-menu" className={`side-menu ${isVisible ? "show-menu" : ""}`}>
          ...
          <ul className="menu-list">
            ...
            <li><a href="/login"><i className="fas fa-sign-in-alt"></i> Se Connecter</a></li>
            <li><a href="/subscriptions"><i className="fa-solid fa-newspaper"></i> Abonnement</a></li>
            <li><a href="#" id="openModal"><i className="fa-solid fa-sync-alt"></i> Reabonnement</a></li>
            ...
            <li><a href="/library"><i className="fas fa-bullhorn"></i> Publicite</a></li>
